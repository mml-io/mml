...
export class PlayCanvasClickTrigger {
  ...
  static init(
    ...
    return new PlayCanvasClickTrigger(playcanvasApp, clickTarget, scene);
  }
  ...
  private handleClick(event: MouseEvent) {
    ...
    const cameraEntity = this.scene.getCamera() as playcanvas.Entity;
    ...
    const result = this.playcanvasApp.systems.rigidbody!.raycastFirst(from, to);
    ...
    if (result) {
      ...
      const mElement = MElement.getMElementFromObject(hitEntity);
