...
var _Animation = class _Animation2 extends MElement {
  ...
  static get observedAttributes() {
    return [..._Animation2.attributeHandler.getAttributes()];
  }
  enable() {
  }
  disable() {
  ...
  addSideEffectChild(child) {
    ...
    if (AttributeLerp.isAttributeLerp(child)) {
      const attr = child.getAnimatedAttributeName();
      if (attr) {
        (_a = this.animatedAttributeHelper) == null ? void 0 : _a.addLerp(child, attr);
      }
    }
    super.addSideEffectChild(child);
  }
  removeSideEffectChild(child) {
    ...
    if (AttributeLerp.isAttributeLerp(child)) {
      const attr = child.getAnimatedAttributeName();
      if (attr) {
        (_a = this.animatedAttributeHelper) == null ? void 0 : _a.removeLerp(child, attr);
      }
    }
    super.removeSideEffectChild(child);
  }
  attributeChangedCallback(name, oldValue, newValue) {
    super.attributeChangedCallback(name, oldValue, newValue);
    _Animation2.attributeHandler.handle(this, name, newValue);
  }
  connectedCallback() {
    var _a;
    super.connectedCallback();
      ...
      weight: [
        ...
        (value) => {
          ...
          if (value !== null) {
            ...
            (_a2 = this.animationGraphics) == null ? void 0 : _a2.setWeight(value, this.props);
          }
        }
      ]
    });
    ...
    for (const name of _Animation2.observedAttributes) {
      const value = this.getAttribute(name);
      if (value !== null) {
        this.attributeChangedCallback(name, null, value);
      }
  ...
  disconnectedCallback() {
    ...
    (_a = this.animationGraphics) == null ? void 0 : _a.dispose();
    this.animationGraphics = null;
    this.animatedAttributeHelper = null;
    super.disconnectedCallback();
  }
...
_Animation.attributeHandler = new AttributeHandler({
  ...
  weight: (instance, newValue) => {
    ...
    if (instance.animatedAttributeHelper) {
      ...
      (_a = instance.animationGraphics) == null ? void 0 : _a.setWeight(instance.props.weight, instance.props);
    }
  },
  loop: (instance, newValue) => {
    var _a;
...
//# sourceMappingURL=chunk-RYJPLXZ2.js.map
