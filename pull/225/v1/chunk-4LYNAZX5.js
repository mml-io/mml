...
function parseColorAttribute(value, defaultValue) {
  return parseAttribute(value, defaultValue, (value2) => {
    ...
    if (value2.indexOf("rgb(") === 0) {
      const rgb = /^rgb\(\s*(-?\d+(?:\.\d+)?(?:[eE][-+]?\d+)?)\s*,\s*(-?\d+(?:\.\d+)?(?:[eE][-+]?\d+)?)\s*,\s*(-?\d+(?:\.\d+)?(?:[eE][-+]?\d+)?)\s*\)$/.exec(
        value2
      );
      if (rgb) {
        return {
    ...
    if (value2.indexOf("rgba(") === 0) {
      const rgba = /^rgba\(\s*(-?\d+(?:\.\d+)?(?:[eE][-+]?\d+)?)\s*,\s*(-?\d+(?:\.\d+)?(?:[eE][-+]?\d+)?)\s*,\s*(-?\d+(?:\.\d+)?(?:[eE][-+]?\d+)?)\s*,\s*(\d*\.?\d+)\s*\)$/.exec(
        value2
      );
      if (rgba) {
        return {
    ...
    if (value2.indexOf("hsl(") === 0) {
      const hsl = /^hsl\(\s*(-?\d+(?:\.\d+)?(?:[eE][-+]?\d+)?)\s*,\s*(-?\d+(?:\.\d+)?%)\s*,\s*(-?\d+(?:\.\d+)?%)\s*\)$/.exec(
        value2
      );
      if (hsl) {
    ...
    if (value2.indexOf("hsla(") === 0) {
      const hsla = /^hsla\(\s*(-?\d+(?:\.\d+)?(?:[eE][-+]?\d+)?)\s*,\s*(-?\d+(?:\.\d+)?%)\s*,\s*(-?\d+(?:\.\d+)?%),\s*(\d+(?:\.\d+)?)\)$/.exec(
        value2
      );
      if (hsla) {
...
//# sourceMappingURL=chunk-4LYNAZX5.js.map
