...
// src/MMLSource.ts
var MMLSource = class _MMLSource {
  constructor(options) {
    this.options = options;
    this.websocket = null;
  }
  static create(options) {
    const mmlSource = new _MMLSource(options);
    mmlSource.init();
    return mmlSource;
  }
  init() {
    ...
    if (isWebsocket) {
      ...
      fetchRemoteStaticMML(this.options.source.url).then((remoteDocumentBody) => {
        this.remoteDocumentWrapper.remoteDocument.append(remoteDocumentBody);
        this.options.fullScreenMMLScene.getLoadingProgressManager().setInitialLoad(true);
      }).catch((err) => {
...
//# sourceMappingURL=chunk-K52IE2F4.js.map
