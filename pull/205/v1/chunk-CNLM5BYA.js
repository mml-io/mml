...
// ../../node_modules/mml-web/build/index.js
...
_Link.attributeHandler = new AttributeHandler({
  href: (instance, newValue) => {
    instance.props.href = newValue !== null ? newValue : void 0;
  },
  target: (instance, newValue) => {
    instance.props.target = newValue !== null ? newValue : void 0;
  }
});
var Link = _Link;
...
var TagDebugMElement = class _TagDebugMElement {
  constructor(mElement) {
    ...
    if (mElementParent) {
      ...
      scene2.getRootContainer().append(this.container);
      this.indentLevel = 0;
    }
  ...
  dispose() {
    ...
    if (this.currentParent instanceof _TagDebugMElement) {
      ...
      this.currentParent.getRootContainer().removeChild(this.container);
      this.currentParent = null;
    }
  }
};
...
// src/ConnectGraphicsAdapterToFullScreenScene.ts
...
function connectGraphicsAdapterToFullScreenScene({
  element,
  graphicsAdapter,
  source,
  windowTarget,
  ...
  let overriddenHandler = null;
  const eventHandler = (element2, event) => {
    if (!overriddenHandler) {
      throw new Error("overriddenHandler not set");
    }
    overriddenHandler(element2, event);
  };
  ...
  if (isWebsocket) {
    ...
    overriddenHandler = (element2, event) => {
      websocket.handleEvent(element2, event);
    };
    return {
      dispose: () => {
    ...
    fetchRemoteStaticMML(source.url).then((remoteDocumentBody) => {
...
//# sourceMappingURL=chunk-CNLM5BYA.js.map
