export const helmetAndDuck = {
  name: "Helmet & Duck",
  description: "3D models with animations and interactions",
  content: {
    "scene.mml": `
...
<m-model x="2" z="-2" id="duck" src="/assets/models/duck.glb" y="0.37872010769124587" collide="true">
